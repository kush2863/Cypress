  ...
  return (
    <React.Fragment>
        <section className='flex flex-col gap-4 justify-center items-start md:items-center'>
            <article className='rounded-full  p-[1px] text-sm dark:bg-gradient-to-r 
            ...
            {subheading ?(<>
            <h2 className='text-left text-3l sm:text-5xl sm:max-w-[750px] md:text-center font-semibold'>
                {title}
            </h2>
